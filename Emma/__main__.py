...
from Emma import TOKEN, bot, dp
from Emma.config import get_bool_key, get_list_key
from Emma.modules import ALL_MODULES, LOADED_MODULES, MOD_HELP
...
if get_bool_key("LOAD_MODULES"):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("Emma.modules." + module_name)
...
import_module("Emma.modules.pm_menu")
# Import misc stuff
import_module("Emma.utils.exit_gracefully")
