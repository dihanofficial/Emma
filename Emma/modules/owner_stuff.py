...
from Emma import Emma_VERSION, bot, dp
from Emma.decorator import COMMANDS_ALIASES, REGISTRED_COMMANDS, register
...
async def stats(message):
    if message.from_user.id in skemmers:
        text = f"<b>Emma {Emma_VERSION} stats</b>\n"
