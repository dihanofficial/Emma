...
from Emma import BOT_USERNAME, dp
from Emma.config import get_bool_key
from Emma.modules.error import parse_update
from Emma.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("Emma.utils.filters." + module_name)
